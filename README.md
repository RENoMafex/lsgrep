...
**1.** Download `lsgrep` either by clicking the green `<> Code` button near the top of this page and click `Download ZIP` or some CLI tool like ```wget``` ```curl -fsSL https://github.com/RENoMafex/``` or 
